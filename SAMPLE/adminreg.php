      ...
      <form action="adminR.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="date" min="1947-01-01" max="2022-01-01" name="dob" required>
          </div>
          <div class="input-box">
            <span class="details">Phone Number</span>
            <input type="text" pattern="[0-9]{10}" placeholder="Enter your number *" name="number" required>
          </div>
          <div class="input-box">
            <span class="details">Adhaar Number</span>
            <input type="text" pattern="[0-9]{12}" placeholder="Enter your  adhar number *" name="anum" required>
          </div>
          <div class="input-box">
            <span class="details">Location(city)</span>
            <input type="text" placeholder="Enter your Location without space*"  name="address" required>
          </div>
          <div class="input-box">
